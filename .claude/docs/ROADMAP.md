...
| Issue | Topic | Depends on |
|---|---|---|
| [#184](https://github.com/zelytra/Librarius/issues/184) | Catalog entries stop losing their provider reference on add — the prerequisite for enriching anything | — |
...
| [#170](https://github.com/zelytra/Librarius/issues/170) | Authentication gate: a branded waiting screen instead of plain text | — |
